(function () {
  ...
  function initWidget() {
    ...
    setTimeout(() => { const badge = document.querySelector('.notification-badge'); if (badge) { badge.classList.add('pulse'); playNotification(); setTimeout(() => badge.classList.remove('pulse'), 2000); } }, 450);
